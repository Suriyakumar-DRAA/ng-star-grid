    ...
    <div class="data-table-container">
      <div class="table-header">
        <div class="table-info-row">
          <span class="record-count">
            <span *ngIf="!loading.isLoading && paginationData">
              {{paginationData.totalCount}} total records
            </span>
            <span *ngIf="loading.isLoading" class="loading-text">
              Loading...
            </span>
            <span *ngIf="loading.error" class="error-text">
              Error: {{loading.error}}
            </span>
          </span>
      ...
      <div class="table-wrapper">
        ...
        <table class="data-table">
                ...
                <div class="header-content">
                  ...
                  <app-filter-dropdown
                    *ngIf="filters.get(column.key) && filtersEnabled"
                    ...
                    (loadOptions)="onLoadOptions(column.key, $event)">
                  </app-filter-dropdown>
                </div>
              </th>
            </tr>
          ...
          <tbody>
            <tr *ngFor="let row of currentData; let i = index" 
                class="data-row" 
                [class.even]="i % 2 === 0"
                [class.odd]="i % 2 === 1">
            ...
            <tr *ngIf="currentData.length === 0 && !loading.isLoading" class="no-data-row">
